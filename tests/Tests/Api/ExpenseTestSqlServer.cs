...
#if TEST_SQLSERVER
public class ExpenseTestSqlServer : IClassFixture<ApiFactorySqlServer<Program>> 
{
    protected readonly ApiFactorySqlServer<Program> _factory;
    ...
    public ExpenseTestSqlServer(ApiFactorySqlServer<Program> factory) { 
        _factory = factory;
